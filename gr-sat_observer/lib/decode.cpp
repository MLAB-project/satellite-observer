...
png_charp strings = "Software";
png_charp stringc = "Channel";
png_charp stringd = "Description";
png_charp stringn = "NOAA POES satellite Image";
png_charp stringv = "Atpdec 1.7  (c) 2004-2005 Thierry Leconte F4DWV";


static png_text text_ptr[] = {
    {PNG_TEXT_COMPRESSION_NONE, strings , stringv, sizeof(version)}
    ,
    {PNG_TEXT_COMPRESSION_NONE, stringc, NULL, 0}
    ,
    {PNG_TEXT_COMPRESSION_NONE, stringd, (png_charp)stringn,
     25}
};
...
int decode (std::string file, std::string mode,int satelliteNumber)
{
	...
	strcpy(imgopt, mode.c_str());
	satnum = satelliteNumber-15;
